...
syntax_ml = dict(
    ...
    cellmagic=[
        [("%%foo a", None), (None, "get_ipython().run_cell_magic('foo', 'a', '')"),],
        [
            ("%%bar 123", None),
            ("hello", None),
            (None, "get_ipython().run_cell_magic('bar', '123', 'hello')"),
        ],
        [("a=5", "a=5"), ("%%cellmagic", "%%cellmagic"),],
    ],
    escaped=[
        [
            ("%abc def \\", None),
    ...
    assign_system=[
        [("a = !bc de \\", None), ("fg", "a = get_ipython().getoutput('bc de fg')"),],
        [
            ("a = !bc de \\", None),
            ("fg\\", None),
...
def test_ipy_prompt():
    ...
    transform_checker(
        [("%%foo", "%%foo"), ("In [1]: bar", "In [1]: bar"),], ipt.ipy_prompt
    )
...
def test_token_input_transformer():
    ...
    ml_tests = [
        [("a = 1.2; b = '''x", None), ("y'''", "a =Decimal ('1.2');b ='''x\ny'''"),],
        [("a = [1.2,", None), ("3]", "a =[Decimal ('1.2'),\n3 ]"),],
        [
